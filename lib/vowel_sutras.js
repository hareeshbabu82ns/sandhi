...
var sutras = {
    ...
    'guna': { // 6.1.87
        ...
        del: function (mark) {
            ...
            // u.log('M', first, mark.second, ends, starts, 222, mark.mark)
    ...
    'dissimilar': { // 6.1.77
        ...
        del: function (mark) {
            ...
            if (mark.stype == 'vowel-cons' && mark.penult == Const.virama) {
                ...
                // u.log('STARTS', u.liga(u.base(mark.fin)), u.dliga(u.base(mark.fin)))
            }
    ...
    'ayadi': { // 6.1.78
        ...
        del: function (mark) {
            ...
            if (mark.avagraha) {
                ...
                if (mark.penult == c.A) {
                    // u.log('=========================== PENULT', u.vowel(mark.mark));
