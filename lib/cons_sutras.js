...
var sutras = {
    ...
    'cons-to-nasal-or-third': { // 8.4.45 // यावदेतान् + निरीक्षः
        del: function (o) {
            var ends;
            if ((u.include(c.Nam, o.fin) && u.include(c.nm, o.beg)) || (u.include(c.class3, o.fin) && u.include(c.nm, o.beg))) {
    ...
    'dental-palatal': { // 8.4.40
        del: function (o) {
            ...
            if (u.include(c.class3, dental)) dental = u.class1(dental); // hard from dental-class3
            var first = o.first.slice(0, -1);
        ...
        add: function (o) {
            // u.log('M', o.fin); // (u.dental(), c.dentals, u.hard(c.dentals), 'P', c.palatals, 333, u.soft(c.palatals));
            var res = [];
            o.first.pop();
            if ((o.fin == 'न') && u.include(u.soft(u.palatal()), o.beg)) { // FIXME: any nasal ????
                o.end = 'ञ';
            } else if (u.include(u.hard(u.dental()), o.fin) && u.include(u.soft(u.palatal()), o.beg)) {
                o.end = 'ज';
                ...
                // if (u.include(c.allvowels, u.vowel(sec)) || u.include(c.yam, sec) || sec == 'ह्') {
                if (u.include(c.allvowels, u.vowel(sec)) || u.isConsonant(sec) || sec == 'ह्') {
                    // u.log('=========OPT');
                ...
                // u.log(111, o.fin, u.dental2palatal(o.fin))
                o.end = u.dental2palatal(o.fin);
            }
            res.push(o);
            // u.log('R', res);
    ...
    'dental-cerebral': { // 8.4.41
        ...
        add: function (o) {
            var res = [];
            o.first.pop();
            if (o.fin == 'न' && u.include(u.soft(u.cerebral()), o.beg)) { // FIXME: any nasal? and the same note for split
                o.end = 'ण';
            } else if (o.fin != 'स' && o.beg == 'ष') {
                o.end = u.dental2cerebral(o.fin);
            } else if (o.fin == 'स') {
                o.end = 'ष';
            } else if (u.include(u.hard(), o.fin) && u.include(u.soft(), o.beg)) {
                o.end = 'ड';
            } else {
                o.end = u.dental2cerebral(o.fin);
            }
    ...
    'm-to-candra': { // 8.3.23
        ...
        del: function (o) {
            // u.log('M', o.beg, c.yava)
            var first = u.wolast(o.first);
            var first_m = [first, c.m, c.virama].join('');
            if (!u.include(c.yava, o.beg)) {
    ...
    'm-to-nasal': {
        ...
        add: function (o) {
            ...
            res.push(ao);
            if (!u.include(c.sibilants, o.beg) && !u.include([c.h, c.ra], o.beg)) res.push(o);
